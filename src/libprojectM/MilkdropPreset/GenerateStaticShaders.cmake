...
file(WRITE "${OUTPUT_DIR}/MilkdropStaticShaders_Content.hpp" "${STATIC_SHADER_CONTENTS}")
file(WRITE "${OUTPUT_DIR}/MilkdropStaticShaders_Declarations.hpp" "${STATIC_SHADER_ACCESSOR_DECLARATIONS}")
file(WRITE "${OUTPUT_DIR}/MilkdropStaticShaders_Implementations.hpp" "${STATIC_SHADER_ACCESSOR_DEFINITIONS}")
